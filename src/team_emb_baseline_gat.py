'''
Aggregates coach features non-hierarchically using attention mechanism
'''
import copy
import pandas as pd
import numpy as np
...
if __name__ == "__main__":
    ...
    train_team_G = construct_seasonal_colleague_network(train_record, 2002, train_split_year)
    ...
    valid_team_G = construct_seasonal_colleague_network(valid_record, train_split_year+1, valid_split_year)
    ...
    test_team_G = construct_seasonal_colleague_network(test_record, valid_split_year+1, 2019)
